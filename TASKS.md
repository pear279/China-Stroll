...
- [ ] Task 6 — Complete Attractions 1.0
  ...
  - Progress 2026-08-30: shared place contracts and trust invariants landed in `packages/shared/src/place-contracts.ts`; deterministic place discovery, reviewed local Q&A retrieval, preference inference and recommendation ranking landed in `packages/shared/src/place-discovery.ts`; focused discovery/contract/shared/navigation tests and full app/Worker typecheck passed in the Attractions 1.0 worktree.
