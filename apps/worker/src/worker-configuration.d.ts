/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: 9cff72b8e74dcf132a50bb0c9074deed)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "WEB_ORIGIN" | "SILICONFLOW_BASE_URL" | "SILICONFLOW_CHAT_MODEL" | "SILICONFLOW_EMBEDDING_MODEL" | "SILICONFLOW_TIMEOUT_MS">> {}
}
