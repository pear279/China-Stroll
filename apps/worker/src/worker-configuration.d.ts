/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: 496d849824dcd941fcaad2cf4e239feb)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	PLACE_AI_RATE_LIMITER: RateLimit;
	SUPABASE_URL: "https://yjguudzllzjdmqsgwtru.supabase.co";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "WEB_ORIGIN" | "SILICONFLOW_BASE_URL" | "SILICONFLOW_CHAT_MODEL" | "SILICONFLOW_EMBEDDING_MODEL" | "SILICONFLOW_TIMEOUT_MS" | "ALLOW_ANONYMOUS_PLACE_AI">> {}
}
